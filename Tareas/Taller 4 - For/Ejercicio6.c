 ...
 * Descripción: Programa que imprime la serie Padovan hasta llegar al número de términos deseado por el usuario.
 */
...
int main()
{
    ...
    // Variables que usaremos para establecer el inicio de Padovan
    int num1 = 1;
    int num2 = 0;
    int num3 = 0;
