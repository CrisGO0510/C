 ...
 * Descripción: Programa que imprime la sucesión de luca.
 */
...
int main()
{
    ...
    printf("La serie de luca 10 veces es: \n");

    // Bucle para generar e imprimir la sucesión de luca
    do
    {
        ...
        num2 = aux;
        // Incrementamos el valor de i, para poder parar las iteraciones
        i++;
    } while (i < 10);
    return 0;
}
